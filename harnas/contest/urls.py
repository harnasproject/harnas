...
contest_urlpatterns = [
    ...
    url(r'^new/$',
        contest.edit,
        name='contest_new'),
    url(r'^(?P<contest_id>\d+)/$',
        contest.details,
        name='contest_details'),
    # contest_fetch_task and contest_edit must be before contest_details with tabs
    url(r'^(?P<contest_id>\d+)/fetch_task/$',
        contest.fetch_task,
        name='contest_fetch_task'),
    url(r'^(?P<contest_id>\d+)/edit/$',
        contest.edit,
        name='contest_edit'),
    url(r'^(?P<contest_id>\d+)/submit/$',
        contest.submit,
        name='contest_submit'),
    url(r'^(?P<contest_id>\d+)/save_submit/$',
        contest.save_submit,
        name='contest_save_submit'),
    url(r'^(?P<contest_id>\d+)/(?P<tab>\w+)/$',
        contest.details,
        name='contest_details'),
